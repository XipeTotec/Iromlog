export const EXERCISES = [
  ...
  { id: 'decline-bench-press', name: 'Decline Bench Press', apiName: 'decline barbell bench press', muscleGroup: 'chest', equipment: 'barbell', custom: false },
  ...
  { id: 'flat-db-press', name: 'Flat DB Press', apiName: 'dumbbell bench press', muscleGroup: 'chest', equipment: 'dumbbell', custom: false },
  { id: 'decline-db-press', name: 'Decline DB Press', apiName: 'decline dumbbell bench press', muscleGroup: 'chest', equipment: 'dumbbell', custom: false },
  { id: 'cable-fly', name: 'Cable Fly', apiName: 'cable fly', muscleGroup: 'chest', equipment: 'cable', custom: false },
  { id: 'cable-crossover', name: 'Cable Crossover', apiName: 'cable crossover', muscleGroup: 'chest', equipment: 'cable', custom: false },
  { id: 'pec-deck', name: 'Pec Deck', apiName: 'pec deck fly', muscleGroup: 'chest', equipment: 'machine', custom: false },
  { id: 'chest-dip', name: 'Chest Dip', apiName: 'chest dip', muscleGroup: 'chest', equipment: 'bodyweight', custom: false },
  ...
  { id: 'chin-up', name: 'Chin Up', apiName: 'chin-up', muscleGroup: 'back', equipment: 'bodyweight', custom: false },
  { id: 'lat-pulldown', name: 'Lat Pulldown', apiName: 'cable lat pulldown', muscleGroup: 'back', equipment: 'cable', custom: false },
  { id: 'wide-lat-pulldown', name: 'Wide Lat Pulldown', apiName: 'wide grip lat pulldown', muscleGroup: 'back', equipment: 'cable', custom: false },
  ...
  { id: 'barbell-row', name: 'Barbell Row', apiName: 'barbell bent over row', muscleGroup: 'back', equipment: 'barbell', custom: false },
  { id: 'pendlay-row', name: 'Pendlay Row', apiName: 'pendlay row', muscleGroup: 'back', equipment: 'barbell', custom: false },
  { id: 'tbar-row', name: 'T-Bar Row', apiName: 't bar row', muscleGroup: 'back', equipment: 'barbell', custom: false },
  { id: 'chest-supported-row', name: 'Chest Supported Row', apiName: 'chest supported row', muscleGroup: 'back', equipment: 'dumbbell', custom: false },
  { id: 'face-pull', name: 'Face Pull', apiName: 'cable face pull', muscleGroup: 'back', equipment: 'cable', custom: false },
  { id: 'straight-arm-pulldown', name: 'Straight Arm Pulldown', apiName: 'straight arm pulldown', muscleGroup: 'back', equipment: 'cable', custom: false },
  { id: 'single-arm-cable-row', name: 'Single Arm Cable Row', apiName: 'single arm cable row', muscleGroup: 'back', equipment: 'cable', custom: false },
  { id: 'hyperextension', name: 'Hyperextension', apiName: 'hyperextension', muscleGroup: 'back', equipment: 'bodyweight', custom: false },
  { id: 'good-morning', name: 'Good Morning', apiName: 'good morning', muscleGroup: 'back', equipment: 'barbell', custom: false },
  ...
  { id: 'arnold-press', name: 'Arnold Press', apiName: 'arnold dumbbell press', muscleGroup: 'shoulders', equipment: 'dumbbell', custom: false },
  { id: 'smith-ohp', name: 'Smith OHP', apiName: 'smith machine overhead press', muscleGroup: 'shoulders', equipment: 'machine', custom: false },
  ...
  { id: 'front-raise', name: 'Front Raise', apiName: 'dumbbell front raise', muscleGroup: 'shoulders', equipment: 'dumbbell', custom: false },
  ...
  { id: 'ez-bar-curl', name: 'EZ Bar Curl', apiName: 'ez bar curl', muscleGroup: 'biceps', equipment: 'barbell', custom: false },
  { id: 'db-curl', name: 'DB Curl', apiName: 'dumbbell curl', muscleGroup: 'biceps', equipment: 'dumbbell', custom: false },
  { id: 'incline-db-curl', name: 'Incline DB Curl', apiName: 'incline dumbbell curl', muscleGroup: 'biceps', equipment: 'dumbbell', custom: false },
  { id: 'concentration-curl', name: 'Concentration Curl', apiName: 'concentration curl', muscleGroup: 'biceps', equipment: 'dumbbell', custom: false },
  ...
  { id: 'cable-hammer-curl', name: 'Cable Hammer Curl', apiName: 'cable hammer curl', muscleGroup: 'biceps', equipment: 'cable', custom: false },
  ...
  { id: 'rope-pushdown', name: 'Rope Pushdown', apiName: 'cable rope triceps pushdown', muscleGroup: 'triceps', equipment: 'cable', custom: false },
  ...
  { id: 'cable-overhead-extension', name: 'Cable Overhead Extension', apiName: 'cable overhead triceps extension', muscleGroup: 'triceps', equipment: 'cable', custom: false },
  ...
  { id: 'front-squat', name: 'Front Squat', apiName: 'barbell front squat', muscleGroup: 'legs', equipment: 'barbell', custom: false },
  { id: 'goblet-squat', name: 'Goblet Squat', apiName: 'dumbbell goblet squat', muscleGroup: 'legs', equipment: 'dumbbell', custom: false },
  { id: 'hack-squat', name: 'Hack Squat', apiName: 'hack squat', muscleGroup: 'legs', equipment: 'machine', custom: false },
  { id: 'smith-squat', name: 'Smith Squat', apiName: 'smith machine squat', muscleGroup: 'legs', equipment: 'machine', custom: false },
  { id: 'bulgarian-split-squat', name: 'Bulgarian Split Squat', apiName: 'dumbbell bulgarian split squat', muscleGroup: 'legs', equipment: 'dumbbell', custom: false },
  { id: 'lunge', name: 'Lunge', apiName: 'dumbbell lunge', muscleGroup: 'legs', equipment: 'dumbbell', custom: false },
  { id: 'walking-lunge', name: 'Walking Lunge', apiName: 'walking lunge', muscleGroup: 'legs', equipment: 'bodyweight', custom: false },
  ...
  { id: 'sumo-deadlift', name: 'Sumo Deadlift', apiName: 'sumo deadlift', muscleGroup: 'legs', equipment: 'barbell', custom: false },
  { id: 'leg-curl', name: 'Leg Curl', apiName: 'leg curl', muscleGroup: 'legs', equipment: 'machine', custom: false },
  { id: 'lying-leg-curl', name: 'Lying Leg Curl', apiName: 'lying leg curl', muscleGroup: 'legs', equipment: 'machine', custom: false },
  { id: 'leg-extension', name: 'Leg Extension', apiName: 'leg extension', muscleGroup: 'legs', equipment: 'machine', custom: false },
  { id: 'hip-thrust', name: 'Hip Thrust', apiName: 'barbell hip thrust', muscleGroup: 'legs', equipment: 'barbell', custom: false },
  { id: 'glute-bridge', name: 'Glute Bridge', apiName: 'glute bridge', muscleGroup: 'legs', equipment: 'bodyweight', custom: false },
  { id: 'calf-raise', name: 'Calf Raise', apiName: 'standing calf raise', muscleGroup: 'legs', equipment: 'machine', custom: false },
  { id: 'seated-calf-raise', name: 'Seated Calf Raise', apiName: 'seated calf raise', muscleGroup: 'legs', equipment: 'machine', custom: false },
  ...
  { id: 'side-plank', name: 'Side Plank', apiName: 'side plank', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'cable-crunch', name: 'Cable Crunch', apiName: 'cable crunch', muscleGroup: 'core', equipment: 'cable', custom: false },
  { id: 'crunch', name: 'Crunch', apiName: 'crunch', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'sit-up', name: 'Sit Up', apiName: 'sit-up', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'leg-raise', name: 'Leg Raise', apiName: 'hanging leg raise', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'hanging-knee-raise', name: 'Hanging Knee Raise', apiName: 'hanging knee raise', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'ab-wheel', name: 'Ab Wheel', apiName: 'ab wheel roller', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'russian-twist', name: 'Russian Twist', apiName: 'russian twist', muscleGroup: 'core', equipment: 'bodyweight', custom: false },
  { id: 'pallof-press', name: 'Pallof Press', apiName: 'pallof press', muscleGroup: 'core', equipment: 'cable', custom: false },
  { id: 'cable-wood-chop', name: 'Cable Wood Chop', apiName: 'cable wood chop', muscleGroup: 'core', equipment: 'cable', custom: false },
